...
def user_logout(request):
    logout(request)
    messages.info(request,"Succesfullly logged out")
    return redirect('user_login')
        ...
        if password_reset_form.is_valid():
            ...
            if associated_users.exists():
                for user in associated_users:
                    ...
                    try:
                        send_mail(subject, email, 'nirushamunikar26@gmail.com' , [user.email], fail_silently=False)
                        # send_mail(subject, email, 'nirushamunikar26@gmail.com' , ['munikarnirusha9@gmail.com'], fail_silently=False)
                        return redirect("/")
